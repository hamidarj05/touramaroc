...
<div class="container auth-main-container">
  ...
  <div class="auth-card auth-card-active" id="forgotCard">
    <div class="auth-card-content">
      <h3 class="text-center">Réinitialiser votre mot de passe</h3>
      <p class="text-center text-muted">Entrez votre email pour vérifier votre compte</p>
      <form id="forgotForm" action="php/checkEmail.php"  method="post">
        <div class="form-group auth-input-group">
          <input type="email" name="email" class="form-control auth-input-field" placeholder="votre@email.com" required />
        </div>
